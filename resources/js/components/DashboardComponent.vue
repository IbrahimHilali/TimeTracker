        ...
        <div class="no-projects" v-if="projects">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <!-- <button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#projectCreate">
                         New Project
                     </button>-->
                     <button class="btn btn-primary btn-sm pull-right" data-toggle="modal" data-target="#uploadFilesModal">
                       Upload CVS
                   </button>
                    <upload></upload>
                </div>
            ...
            <div v-if="projects.length > 0">
                <div class="panel panel-default" v-for="project in projects" :key="project.id">
                    <div class="panel-heading clearfix">
                        ...
                        <!--<button class="btn btn-success btn-sm pull-right" :disabled="counter.timer" data-toggle="modal"-->
                        <!--data-target="#timerCreate" @click="selectedProject = project">-->
                        ...
                        <ul class="list-group" v-if="project.timers.length > 0">
                            <li v-for="timer in project.timers" :key="timer.id" class="list-group-item clearfix">
                                ...
                                <div class="pull-right">
                                    ...
                                    <!--<button v-if="showTimerForProject(project, timer)" class="btn btn-sm btn-danger"-->
                                    <!--@click="stopTimer()">-->
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    <input v-model="newTimerName" type="text" class="form-control" id="usrname1"
                                           placeholder="What are you working on?">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button data-dismiss="modal" v-bind:disabled="newTimerName === ''"
                                        @click="createTimer(selectedProject)" type="submit"
                                        class="btn btn-default btn-primary"><i class="glyphicon glyphicon-play"></i>
                                    Start
                                </button>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="projectCreate" role="dialog">
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <input v-model="newProjectName" type="text" class="form-control" id="usrname"
                                       placeholder="Project Name">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button data-dismiss="modal" v-bind:disabled="newProjectName == ''" @click="createProject"
                                    type="submit" data-target="" class="btn btn-default btn-primary">Create
                            </button>
                        </div>
                    </div>
                </div>
